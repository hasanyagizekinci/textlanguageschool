...
const questions: ContextQ[] = [
  ...
  { id: 41, sentence: "The old building was in a state of **dilapidation**, with broken windows and crumbling walls.", highlightedWord: "dilapidation", options: ["Yenilenme", "İnşaat", "Harap olma/yıkılma", "Dekorasyon"], correct: 2, explanation: "Kırık camlar ve yıkılan duvarlar harap olma durumuna işaret eder." },
  { id: 42, sentence: "His **impeccable** record made him the ideal candidate for the promotion.", highlightedWord: "impeccable", options: ["Sorunlu", "Sıradan", "Tartışmalı", "Kusursuz"], correct: 3, explanation: "Terfi için ideal aday olması, kusursuz bir sicile işaret eder." },
  { id: 43, sentence: "The dictator ruled with **impunity**, never facing punishment for his crimes.", highlightedWord: "impunity", options: ["Cezasızlık", "Adalet", "Merhamet", "Korku"], correct: 0, explanation: "Suçları için hiç ceza görmemesi cezasızlığa işaret eder." },
  ...
  { id: 45, sentence: "The **repercussions** of the policy change were felt across the entire industry.", highlightedWord: "repercussions", options: ["Faydalar", "Kurallar", "Sonuçlar/yansımalar", "Değişiklikler"], correct: 2, explanation: "Politika değişikliğinin tüm sektörde hissedilmesi, sonuç/yansıma anlamına gelir." },
  { id: 46, sentence: "She showed great **fortitude** during her long illness, never complaining once.", highlightedWord: "fortitude", options: ["Zayıflık", "Korku", "Sabırsızlık", "Metanet/dayanıklılık"], correct: 3, explanation: "Uzun hastalığı boyunca hiç şikayet etmemesi metanete işaret eder." },
  { id: 47, sentence: "The **ostentatious** display of wealth made the other guests uncomfortable.", highlightedWord: "ostentatious", options: ["Gösterişli/şatafatlı", "Mütevazı", "Gizli", "Sade"], correct: 0, explanation: "Diğer misafirleri rahatsız eden zenginlik gösterisi, gösterişli olduğunu belirtir." },
  ...
  { id: 49, sentence: "The manager's **arbitrary** decisions frustrated the team because there was no logic behind them.", highlightedWord: "arbitrary", options: ["Mantıklı", "Adil", "Keyfi/gelişigüzel", "Planlı"], correct: 2, explanation: "Arkasında mantık olmaması, kararların keyfi olduğunu gösterir." },
  { id: 50, sentence: "After years of **abstinence**, he finally allowed himself a piece of chocolate.", highlightedWord: "abstinence", options: ["Aşırı tüketim", "Kayıtsızlık", "Bağımlılık", "Perhiz/kaçınma"], correct: 3, explanation: "Yıllarca sonra kendine bir parça çikolata izin vermesi, uzun süreli kaçınmaya işaret eder." },
  { id: 51, sentence: "The **gregarious** host made sure every guest felt welcome at the party.", highlightedWord: "gregarious", options: ["Toplumsal/sosyal", "İçe kapanık", "Kibirli", "Sessiz"], correct: 0, explanation: "Her misafirin kendini iyi hissetmesini sağlamak sosyal/cana yakın olmayı gösterir." },
  ...
  { id: 53, sentence: "The government imposed **stringent** regulations on factory emissions.", highlightedWord: "stringent", options: ["Gevşek", "Geçici", "Katı/sıkı", "İsteğe bağlı"], correct: 2, explanation: "Fabrika emisyonlarına getirilen düzenlemeler katı/sıkı olarak nitelendirilir." },
  { id: 54, sentence: "Her **vivacious** personality lit up every room she entered.", highlightedWord: "vivacious", options: ["Sakin", "Ürkek", "Ciddi", "Canlı/hayat dolu"], correct: 3, explanation: "Girdiği her odayı aydınlatması canlı ve hayat dolu bir kişiliğe işaret eder." },
  { id: 55, sentence: "The **austere** living conditions in the monastery surprised the new monks.", highlightedWord: "austere", options: ["Sade/kemer sıkan", "Lüks", "Rahat", "Modern"], correct: 0, explanation: "Manastırdaki şaşırtıcı yaşam koşulları sade/kemer sıkan anlamına gelir." },
  ...
  { id: 57, sentence: "Her **tenacious** pursuit of the truth eventually uncovered the scandal.", highlightedWord: "tenacious", options: ["Gevşek", "Kısa süreli", "Azimli/inatçı", "Yüzeysel"], correct: 2, explanation: "Gerçeği ortaya çıkarması, azimli ve kararlı bir takip olduğunu gösterir." },
  { id: 58, sentence: "The **lucrative** contract made the small company wealthy overnight.", highlightedWord: "lucrative", options: ["Riskli", "Zararlı", "Uzun vadeli", "Kazançlı/kârlı"], correct: 3, explanation: "Şirketi bir gecede zengin etmesi, sözleşmenin kazançlı olduğunu gösterir." },
  { id: 59, sentence: "The politician made a **disparaging** remark about his opponent during the debate.", highlightedWord: "disparaging", options: ["Küçümseyen/aşağılayan", "Övücü", "Tarafsız", "Destekleyici"], correct: 0, explanation: "Rakibi hakkında yapılan bu yorum, küçümseyen/aşağılayan niteliktedir." },
  ...
  { id: 61, sentence: "The **clandestine** meeting was held in a basement to avoid detection.", highlightedWord: "clandestine", options: ["Resmi", "Kalabalık", "Gizli/el altından", "Planlı"], correct: 2, explanation: "Fark edilmemek için bodrum katta yapılması gizli olduğunu gösterir." },
  { id: 62, sentence: "His **prodigious** talent for mathematics was evident from a young age.", highlightedWord: "prodigious", options: ["Sıradan", "Zayıf", "Geç gelişen", "Olağanüstü/harika"], correct: 3, explanation: "Küçük yaştan belli olan yetenek olağanüstü niteliktedir." },
  { id: 63, sentence: "The **mundane** tasks of daily life often leave people feeling uninspired.", highlightedWord: "mundane", options: ["Sıradan/monoton", "Heyecanlı", "Karmaşık", "Yaratıcı"], correct: 0, explanation: "İnsanları ilhamsız bırakan günlük işler sıradan/monoton niteliktedir." },
  ...
  { id: 65, sentence: "The **archaic** laws were finally updated to reflect modern values.", highlightedWord: "archaic", options: ["Modern", "Yeni", "Eski/kadim", "İlerici"], correct: 2, explanation: "Modern değerleri yansıtmak için güncellenmesi, yasaların eski olduğunu gösterir." },
  { id: 66, sentence: "She spoke with such **conviction** that everyone believed her story.", highlightedWord: "conviction", options: ["Şüphe", "Korku", "Tereddüt", "İnanç/kesinlik"], correct: 3, explanation: "Herkesin hikayesine inanması, kesinlik ve inançla konuştuğunu gösterir." },
  { id: 67, sentence: "The **prolific** author published over forty novels in his career.", highlightedWord: "prolific", options: ["Üretken/velut", "Yavaş", "Tanınmayan", "Sıradan"], correct: 0, explanation: "Kırk romanın üzerinde yayımlamak üretken olduğunu gösterir." },
  ...
  { id: 69, sentence: "He made a **spontaneous** decision to quit his job and travel the world.", highlightedWord: "spontaneous", options: ["Planlı", "Zorunlu", "Anlık/içgüdüsel", "Mantıklı"], correct: 2, explanation: "Ani bir karar vererek işini bırakması anlık/içgüdüsel olduğunu gösterir." },
